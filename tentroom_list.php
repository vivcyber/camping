...
$t_sql = "SELECT COUNT(1) FROM camptent";
...
if ($totalRows > 0) {
    ...
    $sql = sprintf("SELECT * FROM camptent ORDER BY sid DESC LIMIT %s, %s", ($page - 1) * $perPage, $perPage);
    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <th scope="col">#</th>
                <th scope="col">營地種類</th>
                <th scope="col">營地介紹</th>
                <th scope="col"></th>可容納人數</th>
                <th scope="col">價錢</th>
                <th scope="col">類型</th>
