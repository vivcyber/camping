...
CREATE TABLE `activities` (
  ...
  `ac_price` varchar(255) NOT NULL,
  `ac_info` text NOT NULL,
  `ac_schdule` text NOT NULL,
  `ac_notice` text NOT NULL,
  `ac_time` varchar(255) NOT NULL
...
INSERT INTO `activities` (`sid`, `ac_name`, `ac_price`, `ac_info`, `ac_schdule`, `ac_notice`, `ac_time`) VALUES
(1, '漂流探險', '1000', '輕鬆自在：\r\n利用溪水漂流的方式，一覽南澳獨特山水景色，並享受沁涼溪水的小旅行。\r\n老少咸宜：\r\n在漂流行程中，除可讓小孩子學習獨立自主的行為態度，更能有效促進親子關係唷！\r\n安全有趣：\r\n溪水漂流活動好玩安全，除行前的安全規定與訓練教學外，全程皆由教練陪同，不但讓大家玩得安全，更玩得盡興！', '09:00 農場集合\r\n09:30 出發換裝、行前講解、暖身\r\n10:00 開始漂流，沿途體驗沁涼溪水、激流冒險、團隊互助、壯闊山景！\r\n12:00 返回農場洗澡換裝', '活動費用不含交通接駁，請您自行開車前往至指定地點集合。\r\n當天集合時到場後請主動與帶隊教練或承辦人電話聯繫，以避免找不到人。\r\n活動過程中，需聽從教練指示，不得脫隊，不得卸下任何安全裝備。\r\n活動當天集合時，請勿遲到。為確保其他參加者的權益，遲到超過半小時，不再等待直接出發，且無退款。\r\n本公司教練保留臨場路線規劃及活動安排之權利。\r\n當天天氣狀況視情況照常進行，除非另外通知。', '09:00-12:00'),
(2, '親子溯溪', '1200', '適合初學者，行程促進親子交流與團隊互助，體驗在溪流中冒險的強健心智！\r\n造訪不為人知的世外桃源，無名溪水質豐沛清澈，沿途的小瀑布一座接一座，生態魚況豐富，溯行探密最能發掘它的樂趣。\r\n4人以上方可成團，歡迎預約報名。', '13:00 集合（請自行開車前往）\r\n14:30 出發換裝、行前講解、暖身\r\n15:00 開始溯溪，逆流而上，沿途體驗峽谷、深潭，團隊互助、溪流冒險\r\n16:00 洗澡換裝', '活動費用不含交通接駁，請您自行開車前往至指定地點集合。\r\n當天集合時到場後請主動與帶隊教練或承辦人電話聯繫，以避免找不到人。\r\n活動過程中，需聽從教練指示，不得脫隊，不得卸下任何安全裝備。\r\n活動當天集合時，請勿遲到。為確保其他參加者的權益，遲到超過半小時，不再等待直接出發，且無退款。\r\n本公司教練保留臨場路線規劃及活動安排之權利。\r\n當天天氣狀況視情況照常進行，除非另外通知。', '13:00-16:00');
...
INSERT INTO `campland` (`sid`, `areaname`, `areainfo`, `areatype`, `openingtime`) VALUES
(1, '烤肉區Ａ', '大朋友小朋友快樂烤肉的好地方', '需預訂', '每天'),
(2, '服務台', '在這裡預定行程 入住 以及訂購各種活動', '公共空間', '早上09:00-晚上09:00'),
(3, '露營車區', '享受時下最潮的露營車體驗，不必流汗搭帳，車內備有冷暖氣、舒眠睡墊，適合親子家庭、好友聚會，輕鬆暢遊山林，感受時尚舒適的自然輕旅行。', '需預訂', '入住時間 下午15:00-21:00'),
(4, '大草地', '前進溪谷廣闊山景，享受穿越在不同地形上的樂趣！徜徉南澳溪谷、沙灘奔馳、叢林穿越、網美拍照。親子情侶或是三五好友都能雙載輕鬆玩，兩人即可出發！', '公共空間', '全日');
...
CREATE TABLE `camptent` (
  `sid` int(11) NOT NULL,
  `tentname` varchar(255) NOT NULL,
  `tentinfo` text NOT NULL,
  `people` varchar(255) NOT NULL,
  `price` varchar(255) NOT NULL,
  `tenttype` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `camptent` (`sid`, `tentname`, `tentinfo`, `people`, `price`, `tenttype`) VALUES
(1, '浪漫豪華露營帳', '帶上簡單行李就能出發，體驗專為台灣氣候設計的絕美泰雅圖騰帳，在那山那谷的山谷綠茵中露營，由專人搭收所有設備。仰望星空、山嵐，聆聽蟲鳴、鳥叫，享受以自然為家的生活，感受變慢的戶外時光。', '4-6人', '5700', '豪華帳棚'),
(2, '低調奢華露營帳', '帶上簡單行李就能出發，體驗專為台灣氣候設計的絕美泰雅圖騰帳，在那山那谷的山谷綠茵中露營，由專人搭收所有設備。仰望星空、山嵐，聆聽蟲鳴、鳥叫，享受以自然為家的生活，感受變慢的戶外時光。', '4-6人', '5700', '豪華帳棚'),
(3, '圖騰露營車', '享受時下最潮的露營車體驗，不必流汗搭帳，車內備有冷暖氣、舒眠睡墊，適合親子家庭、好友聚會，輕鬆暢遊山林，感受時尚舒適的自然輕旅行。', '2-3', '4800', '露營車'),
(4, '碎石區自搭帳', '自搭帳享受露營樂趣', '4-5', '1000', '營地'),
(5, '草地區自搭帳', '自搭帳享受露營樂趣', '4-5', '1500', '營地');
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `campland`
--
ALTER TABLE `campland`
...
--
ALTER TABLE `camproduct`
  MODIFY `sid` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `camproduct2`
--
ALTER TABLE `camproduct2`
  MODIFY `sid` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `camptent`
--
ALTER TABLE `camptent`
