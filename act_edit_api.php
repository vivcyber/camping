...
$sql= "UPDATE `act` SET `act_name`=?,`act_s_time`=?,`act_e_time`=?,`min_people`=?,`max_people`=?,`min_age`=?,`max_age`=?,`act_price`=?,`act_desc`=?,`act_notice`=?,`act_schedule`=?,`act_prepare`=? WHERE `act_id`=$act_id";
