...
$sid = isset($_POST['sid']) ? intval($_POST['sid']) : 0;
    if(isset($_POST['edit']))
    {
        ...
        $query="UPDATE `camproduct2` SET `productname`='$productname',`productcategory`='$productcategory',`productcolor`='$productcolor',`productinfo`='$productinfo',`productimg`='$productimg',`productprice`='$productprice',`productleft`='$productleft',`productspec`='$productspec',`productinclude`='$productinclude',`productimg2`='$productimg2',`productimg3`='$productimg3' WHERE `sid`=$sid";
