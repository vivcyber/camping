...
$row3 = $pdo->query("SELECT * FROM room_photo WHERE Room_Type='" . $sid . "' Group BY Room_Image")->fetchAll(PDO::FETCH_ASSOC);
...
<div class="container">
    <div class="row">
        <div class="">
            <div class="card">
                <div class=" card-body">
                    <h5 class="card-title pb-5 pt-5">編輯資料</h5>
                    <form class="d-flex justify-content-between" name="form1" enctype="multipart/form-data" onsubmit="sendData(); return false;" novalidate>
                        ...
                        <div style="margin-right:10px">
                            <div id="killSID"><input type="hidden" name="SID" value="<?= $row['SID'] ?>"></div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="Room_Type" name="Room_Type" onchange="Fetchkey(this.value);FetchPrice(this.value);FetchImages(this.value);FetchSID(this.value); return false;">
                            ...
                            <div class="mb-3" id="room_spec">
                                ...
                                <input type="checkbox" id="Room_Spec" name="Room_spec[]" value="Washroom" <?php
                                                                                                            ...
                                                                                                            ?>>沐浴間
                                <input type="checkbox" id="Room_Spec" name="Room_spec[]" value="Towel" <?php

                                                                                                        if (in_array("Towel", $r_spec)) {
                                                                                                            echo $str;
                                                                                                        }
                                                                                                        ?>>毛巾
                                <input type="checkbox" id="Room_Spec" name="Room_spec[]" value="Sliper" <?php

                                                                                                        if (in_array("Sliper", $r_spec)) {
                                                                                                            echo $str;
                                                                                                        }
                                                                                                        ?>>拖鞋
                                <input type="checkbox" id="Room_Spec" name="Room_spec[]" value="Desk" <?php
                                                                                                        ...
                                                                                                        ?>>書桌
                                <input type="checkbox" id="Room_Spec" name="Room_spec[]" value="Television" <?php

                                                                                                            if (in_array("Television", $r_spec)) {
                                                                                                                echo $str;
                                                                                                            }
                                                                                                            ?>>平面電視
                                <input type="checkbox" id="Room_Spec" name="Room_spec[]" value="Phone" <?php
                                                                                                        ...
                                                                                                        ?>>電話
                                <input type="checkbox" id="Room_Spec" name="Room_spec[]" value="Channel" <?php
                            ...
                            <div class="" style="border-bottom:1px dotted #E5E3E6; padding-bottom:1rem;">
                                <input type="file" id="files" name="files[]" accept=".jpg,.jpeg,.png,.gif,.tif" class="btn btn-primary" multiple>
                            ...
                            <div class="gallery-img gallery-size" id="imageblock">
                                <?php foreach ($row3 as $ImgRow) : ?>
                                    <?php if (strlen($ImgRow['Room_Image']) != 0) { ?>
                                        <div class="img-box ml-1 mr-1 position-relative" id="" <?php $ImgRow['sid'] ?>>
                                            <img src="./imgs/Roomimg/<?= $ImgRow['Room_Image'] ?>" class="images-size ml-2" alt="">
                                            <button class="badge badge-danger circleflow" onclick="deleteImage('<?php echo $ImgRow['sid']?>');"> X </button>
                                        </div>
                                    <?php } ?>
                                <?php endforeach ?>
                            </div>
